...
class MtxFx22(Union):
    ...
    m: Float[Tensor, "2 2"] (struct_fx32[2][2])
    a: Float[Tensor, "4"] (struct_fx32[4])
    ```
    """
    _pack_: ClassVar[int] = 1
    _0: struct_MtxFx22_0
...
class airship_t(Structure):
    ...
    baseElevation: float (struct_fx32)
...
class bakubaku_t(Structure):
    ...
    triggerPos: Float[Tensor, "3"] (struct_VecFx32)
    state: int (POINTER(I))
...
class balloon_t(Structure):
    ...
    color: int (POINTER(i))
    gapAC: int (POINTER(I))
    fieldB0: Float[Tensor, "3"] (struct_VecFx32)
    fieldBC: Float[Tensor, "3"] (struct_VecFx32)
    ...
    scale: int (POINTER(i))
    fieldE8: Float[Tensor, "3"] (struct_VecFx32)
    ...
    color: int
    gapAC: int
    fieldB0: Float[Tensor, "3"]
    fieldBC: Float[Tensor, "3"]
    fieldC8: int
    fieldCC: int
...
class bridge_t(Structure):
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    animProgress: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
...
class cam_params_t(Structure):
    ...
    maxTargetElevation: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    distance: float
    elevation: float
    maxTargetElevation: float
...
class col_entry_t(Structure):
    ...
    zMax: float (struct_fx32)
    zMin: float (struct_fx32)
    position: POINTER_T[struct_VecFx32] (POINTER(struct_VecFx32))
    boundingSphereRadius: float (struct_fx32)
    flags: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
...
class col_response_t(Structure):
    """
    ```python
    maxSomething: Float[Tensor, "3"] (struct_VecFx32)
    minSomething: Float[Tensor, "3"] (struct_VecFx32)
    distance: float (struct_fx32)
    normal: Float[Tensor, "3"] (struct_VecFx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    maxSomething: Float[Tensor, "3"]
    minSomething: Float[Tensor, "3"]
    distance: float
...
class crab_t(Structure):
    ...
    rotZ: int (POINTER(H))
    counter: int (POINTER(i))
    bodyNsbtpFrame: float (struct_fx32)
    handNsbtpFrame: float (struct_fx32)
    ...
    rotZ: int
    counter: int
    bodyNsbtpFrame: float
    handNsbtpFrame: float
...
class dce_t(Structure):
    ...
    blurProgress: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    mode: int
...
class dcol_inst_t(Structure):
    ...
    _pack_: ClassVar[int] = 1
    mobj: struct_mobj_inst_t
    lastMtx: Float[Tensor, "3 3"]
    baseMtx: Float[Tensor, "3 3"]
    lastPosition: Float[Tensor, "3"]
    basePos: Float[Tensor, "3"]
    size: Float[Tensor, "3"]
    sizeZ2: float
    isFloorYZ: int
    isFloorXZ: int
...
class dossun_t(Structure):
    ...
    someSpeed: float (struct_fx32)
    floorY: float (struct_fx32)
    ...
    sinAmplitude: float (struct_fx32)
    pathwalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    initialPathPoint: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
    isHorizontalMoveType: int (POINTER(i))
    fieldF4: Float[Tensor, "3"] (struct_VecFx32)
    field100: float (struct_fx32)
    someAcceleration: float (struct_fx32)
    anotherSpeed: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    mobj: struct_mobj_inst_t
...
class dram_t(Structure):
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    currentSpeed: float (struct_fx32)
    startStopSpeed: float (struct_fx32)
...
class efbub_t(Structure):
    ...
    lowYPos: float (struct_fx32)
    rotation: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
    highYPos: float (struct_fx32)
    shadow: struct_objshadow_t (struct_objshadow_t)
    driverHitMask: int (POINTER(B))
    PADDING_1: list[int] (POINTER(B)[3])
...
class fireball2_t(Structure):
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    fireballDistance: float (struct_fx32)
    ...
    driverHitTimeouts: list[int] (POINTER(i)[8])
    playerDistanceFromRing: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    mobj: struct_mobj_inst_t
...
class flipper_t(Structure):
    ...
    baseMatrices: list[Float[Tensor, "4 3"]] (union_MtxFx43[30])
    extraColMatrices: list[Float[Tensor, "4 3"]] (union_MtxFx43[30])
    ptclEmitterPositions: list[Float[Tensor, "3"]] (struct_VecFx32[30])
    ptclEmitterTargets: list[Float[Tensor, "3"]] (struct_VecFx32[30])
    waitCounter: int (POINTER(i))
    ...
    fieldA0: int
    modelFlip: int
    baseMatrices: list[Float[Tensor, "4 3"]]
    extraColMatrices: list[Float[Tensor, "4 3"]]
    ptclEmitterPositions: list[Float[Tensor, "3"]]
    ptclEmitterTargets: list[Float[Tensor, "3"]]
    waitCounter: int
...
class gesso_t(Structure):
    ...
    field138: int (POINTER(i))
    field13C: Float[Tensor, "3"] (struct_VecFx32)
    field148: Float[Tensor, "3"] (struct_VecFx32)
    field154: Float[Tensor, "3"] (struct_VecFx32)
    field160: int (POINTER(i))
    field164: int (POINTER(i))
    field168: int (POINTER(i))
    field16C: int (POINTER(i))
    field170: int (POINTER(i))
    field174: Float[Tensor, "3"] (struct_VecFx32)
    field180: Float[Tensor, "3"] (struct_VecFx32)
    field18C: int (POINTER(i))
    gap190: int (POINTER(I))
    field194: int (POINTER(i))
    visible: int (POINTER(i))
    field19C: float (struct_fx32)
    ...
    field138: int
    field13C: Float[Tensor, "3"]
    field148: Float[Tensor, "3"]
    field154: Float[Tensor, "3"]
    field160: int
    field164: int
    field168: int
    field16C: int
    field170: int
    field174: Float[Tensor, "3"]
    field180: Float[Tensor, "3"]
    field18C: int
    gap190: int
    field194: int
    visible: int
...
class iball_t(Structure):
    ...
    fieldC0: float (struct_fx32)
    pathwalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    shadow: struct_objshadow_t (struct_objshadow_t)
    routePos: Float[Tensor, "3"] (struct_VecFx32)
...
class idk_struct2_t(Structure):
    """
    ```python
    value: float (struct_fx32)
    velocity: float (struct_fx32)
    min: float (struct_fx32)
    max: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    value: float
...
class it_driver_dragitem_t(Structure):
    ...
    driverId: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
    field2C: Float[Tensor, "4 3"] (union_MtxFx43)
    field5C: Float[Tensor, "3"] (struct_VecFx32)
    field68: int (POINTER(i))
    field6C: Float[Tensor, "3"] (struct_VecFx32)
    field78: int (POINTER(i))
    field7C: int (POINTER(i))
    field80: int (POINTER(i))
    field84: Float[Tensor, "3"] (struct_VecFx32)
    field90: Float[Tensor, "3"] (struct_VecFx32)
    field9C: Float[Tensor, "3"] (struct_VecFx32)
    fieldA8: Float[Tensor, "3"] (struct_VecFx32)
    fieldB4: Float[Tensor, "3"] (struct_VecFx32)
    gapC0: list[int] (POINTER(B)[12])
    fieldCC: list[int] (POINTER(i)[3])
    fieldD8: Float[Tensor, "3"] (struct_VecFx32)
    ...
    driverId: int
    PADDING_0: list[int]
    field2C: Float[Tensor, "4 3"]
    field5C: Float[Tensor, "3"]
    field68: int
    field6C: Float[Tensor, "3"]
    field78: int
    field7C: int
    field80: int
    field84: Float[Tensor, "3"]
    field90: Float[Tensor, "3"]
    field9C: Float[Tensor, "3"]
    fieldA8: Float[Tensor, "3"]
    fieldB4: Float[Tensor, "3"]
    gapC0: list[int]
    fieldCC: list[int]
    fieldD8: Float[Tensor, "3"]
    fieldE4: int
    fieldE8: int
    fieldEC: list[int]
    field12C: list[int]
...
class kuribo_t(Structure):
    ...
    ```python
    mobj: struct_mobj_inst_t (struct_mobj_inst_t)
    fieldA0: float (struct_fx32)
    direction: Float[Tensor, "4"] (struct_quaternion_t)
    targetDir: Float[Tensor, "4"] (struct_quaternion_t)
    squashRatio: float (struct_fx32)
    squashVelocity: float (struct_fx32)
    pathWalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    frame: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
    ...
    mobj: struct_mobj_inst_t
    fieldA0: float
    direction: Float[Tensor, "4"]
    targetDir: Float[Tensor, "4"]
    squashRatio: float
    squashVelocity: float
    pathWalker: struct_pw_pathwalker_t
    frame: int
    PADDING_0: list[int]
    fieldF4: int
...
class mobj_table_entry_t(Structure):
    ...
    ```python
    id: int (POINTER(I))
    def: POINTER_T[struct_mobj_def_t] (POINTER(struct_mobj_def_t))
    arg: c_void_p (c_void_p)
    ```
    """
    _pack_: ClassVar[int] = 1
    id: int
    def: POINTER_T[struct_mobj_def_t]
    arg: c_void_p
...
class pakkunfire_t(Structure):
    ...
    pathwalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    elevation: float (struct_fx32)
    elevationVelocity: float (struct_fx32)
    state: int (POINTER(I))
...
class pendulum_t(Structure):
    ...
    rotation: Float[Tensor, "4"] (struct_quaternion_t)
    prevPosition: Float[Tensor, "3"] (struct_VecFx32)
    renderPos: Float[Tensor, "3"] (struct_VecFx32)
    shadowMtx: Float[Tensor, "4 3"] (union_MtxFx43)
    offsetY: float (struct_fx32)
    ...
    rotation: Float[Tensor, "4"]
    prevPosition: Float[Tensor, "3"]
    renderPos: Float[Tensor, "3"]
    shadowMtx: Float[Tensor, "4 3"]
    offsetY: float
    swingRange: int
    swingVelocity: int
    angle: int
...
class ptcm_camflashes_t(Structure):
    """
    ```python
    directions: list[Float[Tensor, "3"]] (struct_VecFx32[6])
    ...
    """
    _pack_: ClassVar[int] = 1
    directions: list[Float[Tensor, "3"]]
...
class pukupuku_t(Structure):
    ...
    fieldB8: Float[Tensor, "3"] (struct_VecFx32)
    fieldC4: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
    shadow: struct_objshadow_t (struct_objshadow_t)
    fieldFC: int (POINTER(I))
    field100: float (struct_fx32)
    field104: float (struct_fx32)
    field108: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    rdmobj: struct_rotdiemobj_t
    fieldB8: Float[Tensor, "3"]
    fieldC4: int
    PADDING_0: list[int]
    shadow: struct_objshadow_t
    fieldFC: int
...
class pw_path_part_t(Structure):
    """
    ```python
    p0: Float[Tensor, "3"] (struct_VecFx32)
    p1: Float[Tensor, "3"] (struct_VecFx32)
    p2: Float[Tensor, "3"] (struct_VecFx32)
    p3: Float[Tensor, "3"] (struct_VecFx32)
    length: float (struct_fx32)
    oneDivLength: int (POINTER(i))
    hermLength: float (struct_fx32)
    oneDivHermLength: int (POINTER(i))
    linLength: float (struct_fx32)
    oneDivLinLength: int (POINTER(i))
    field48: Float[Tensor, "3"] (struct_VecFx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    p0: Float[Tensor, "3"]
...
class rotcyl_params_t(Structure):
    ...
    sizeX: float (struct_fx32)
    sizeY: float (struct_fx32)
    type: int (POINTER(I))
...
class rotcyl_t(Structure):
    ...
    velocityProgress: float (struct_fx32)
    startStopSpeed: float (struct_fx32)
    field154: int (POINTER(I))
    type: int (POINTER(I))
    sfxId: int (POINTER(I))
...
class rotdiemobj_t(Structure):
    ...
    ```python
    mobj: struct_mobj_inst_t (struct_mobj_inst_t)
    dieMinY: float (struct_fx32)
    dieYAccel: float (struct_fx32)
    dieRotZDir: int (POINTER(i))
    dieRotZ: int (POINTER(H))
    dieRotZSpeed: int (POINTER(H))
    dieInitialYVelo: float (struct_fx32)
    fieldB4: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    mobj: struct_mobj_inst_t
...
class rptc_driver_effect_controller_t(Structure):
    ...
    tireEmitterPositions: list[Float[Tensor, "3"]] (struct_VecFx32[2])
    tireEmitterAxes: list[Float[Tensor, "3"]] (struct_VecFx16[2])
    ```
    """
    _pack_: ClassVar[int] = 1
    emitterId: int
    ...
    tireEmitterPositions: list[Float[Tensor, "3"]]
    tireEmitterAxes: list[Float[Tensor, "3"]]
...
class sanbo_part_t(Structure):
    """
    ```python
    dieingPosition: Float[Tensor, "3"] (struct_VecFx32)
    dieingVelocity: Float[Tensor, "3"] (struct_VecFx32)
    scaleXY: float (struct_fx32)
    ...
    """
    _pack_: ClassVar[int] = 1
    dieingPosition: Float[Tensor, "3"]
    dieingVelocity: Float[Tensor, "3"]
    scaleXY: float
...
class secondhand_t(Structure):
    ...
    ```python
    mobj: struct_mobj_inst_t (struct_mobj_inst_t)
    curRotation: Float[Tensor, "4"] (struct_quaternion_t)
    baseRotation: Float[Tensor, "4"] (struct_quaternion_t)
    startStopFrameCount: int (POINTER(H))
    oneDirFrameCount: int (POINTER(H))
    waitFrameCount: int (POINTER(H))
    baseVelocity: int (POINTER(h))
    velocity: float (struct_fx32)
    acceleration: float (struct_fx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    mobj: struct_mobj_inst_t
    curRotation: Float[Tensor, "4"]
    baseRotation: Float[Tensor, "4"]
    startStopFrameCount: int
...
class sfsn_t(Structure):
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    state0Counter: int (POINTER(i))
    spawnPos: Float[Tensor, "3"] (struct_VecFx32)
    angle: int (POINTER(H))
    PADDING_1: list[int] (POINTER(B)[2])
    state: int (POINTER(I))
...
class sfx_params_t(Structure):
    ...
    fadeStartDistance: int (POINTER(i))
    maxVolume: int (POINTER(i))
    fadePart1Factor: float (struct_fx32)
    fadePart2Factor: float (struct_fx32)
    field1C: int (POINTER(I))
    ...
    fadeStartDistance: int
    maxVolume: int
    fadePart1Factor: float
    fadePart2Factor: float
    field1C: int
...
class sinthing_t(Structure):
    ...
    value: float (struct_fx32)
    velocity: float (struct_fx32)
    baseOffset: float (struct_fx32)
    amplitude: float (struct_fx32)
    amplitudeVelocity: float (struct_fx32)
...
class snowman_t(Structure):
    ...
    counter: int (POINTER(i))
    headElevationProgress: float (struct_fx32)
    bottomScale: float (struct_fx32)
    headElevation: float (struct_fx32)
    headElevationVelocity: float (struct_fx32)
    headMaxElevation: float (struct_fx32)
    headMinElevation: float (struct_fx32)
    state: int (POINTER(I))
    ```
    """
    _pack_: ClassVar[int] = 1
    ...
    counter: int
    headElevationProgress: float
    bottomScale: float
    headElevation: float
    headElevationVelocity: float
    headMaxElevation: float
    headMinElevation: float
    state: int
...
class spa_emitter_t(Structure):
    ...
    position: Float[Tensor, "3"] (struct_VecFx32)
    velocity: Float[Tensor, "3"] (struct_VecFx32)
    particleVelocity: Float[Tensor, "3"] (struct_VecFx32)
    age: int (POINTER(H))
    lastEmissionFraction: float (struct_fx16)
    axis: Float[Tensor, "3"] (struct_VecFx16)
    particleRotation: int (POINTER(H))
    emissionCount: float (struct_fx32)
    radius: float (struct_fx32)
    length: float (struct_fx32)
    particlePosVeloMag: float (struct_fx32)
    particleAxisVeloMag: float (struct_fx32)
    particleScale: float (struct_fx32)
    particleLifetime: int (POINTER(H))
    color: int (POINTER(H))
    collisionPlaneYOverride: float (struct_fx32)
    texS: float (struct_fx16)
    texT: float (struct_fx16)
    childTexS: float (struct_fx16)
    childTexT: float (struct_fx16)
    emissionInterval: int (POINTER(I))
    particleAlpha: int (POINTER(I))
    updateMoment: int (POINTER(I))
    field80Unk2: int (POINTER(I))
    axisRight: Float[Tensor, "3"] (struct_VecFx16)
    axisUp: Float[Tensor, "3"] (struct_VecFx16)
    ...
    position: Float[Tensor, "3"]
    velocity: Float[Tensor, "3"]
    particleVelocity: Float[Tensor, "3"]
    age: int
    lastEmissionFraction: float
    axis: Float[Tensor, "3"]
    particleRotation: int
    emissionCount: float
    radius: float
    length: float
    particlePosVeloMag: float
    particleAxisVeloMag: float
    particleScale: float
    particleLifetime: int
    color: int
    collisionPlaneYOverride: float
    texS: float
    texT: float
    childTexS: float
    childTexT: float
    ...
    updateMoment: int
    field80Unk2: int
    axisRight: Float[Tensor, "3"]
    axisUp: Float[Tensor, "3"]
...
class spa_particle_t(Structure):
    ...
    alpha: int (POINTER(H))
    polygonId: int (POINTER(H))
    baseScale: float (struct_fx32)
    scale: float (struct_fx16)
    color: int (POINTER(H))
    basePosition: Float[Tensor, "3"] (struct_VecFx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    listLink: struct_spa_list_link_t
...
class spa_res_emitter_field_collision_t(Structure):
    """
    ```python
    collisionPlaneY: float (struct_fx32)
    bounceCoef: float (struct_fx16)
    behavior: int (POINTER(H))
    _3: int (POINTER(H))
    ```
    """
    _pack_: ClassVar[int] = 1
    collisionPlaneY: float
    bounceCoef: float
    behavior: int
    _3: int
...
class spa_res_emitter_field_convergence_t(Structure):
    """
    ```python
    convergencePos: Float[Tensor, "3"] (struct_VecFx32)
    convergenceRatio: float (struct_fx16)
    padding: int (POINTER(H))
    ```
    """
    _pack_: ClassVar[int] = 1
    convergencePos: Float[Tensor, "3"]
...
class spa_res_emitter_field_gravity_t(Structure):
    """
    ```python
    gravity: Float[Tensor, "3"] (struct_VecFx16)
    padding: int (POINTER(H))
    ```
    """
    _pack_: ClassVar[int] = 1
    gravity: Float[Tensor, "3"]
    padding: int

class spa_res_emitter_field_magnet_t(Structure):
    """
    ```python
    magnetPos: Float[Tensor, "3"] (struct_VecFx32)
    magnetPower: float (struct_fx16)
    padding: int (POINTER(H))
    ```
    """
    _pack_: ClassVar[int] = 1
    magnetPos: Float[Tensor, "3"]
    magnetPower: float
    padding: int
...
class spa_res_emitter_field_random_t(Structure):
    """
    ```python
    strength: Float[Tensor, "3"] (struct_VecFx16)
    interval: int (POINTER(H))
    ```
    """
    _pack_: ClassVar[int] = 1
    strength: Float[Tensor, "3"]
    interval: int
...
class spa_res_emitter_scaleanim_t(Structure):
    """
    ```python
    initialScale: float (struct_fx16)
    intermediateScale: float (struct_fx16)
    endingScale: float (struct_fx16)
    inCompletedTiming: int (POINTER(B))
...
class spa_res_emitter_t(Structure):
    ...
    position: Float[Tensor, "3"] (struct_VecFx32)
    emissionCount: float (struct_fx32)
    emitterRadius: float (struct_fx32)
    emitterLength: float (struct_fx32)
    emitterAxis: Float[Tensor, "3"] (struct_VecFx16)
    color: int (POINTER(H))
    particlePosVeloMag: float (struct_fx32)
    particleAxisVeloMag: float (struct_fx32)
    particleBaseScale: float (struct_fx32)
    aspectRatio: float (struct_fx16)
    ...
    _34: int (POINTER(L))
    quadXOffset: float (struct_fx16)
    quadYZOffset: float (struct_fx16)
    ...
    emitterRadius: float
    emitterLength: float
    emitterAxis: Float[Tensor, "3"]
    color: int
    particlePosVeloMag: float
    particleAxisVeloMag: float
    particleBaseScale: float
    aspectRatio: float
...
class struct_sun_t(Structure):
    ...
    rotZB: int (POINTER(H))
    nsbcaFrame: int (POINTER(H))
    nsbcaAnimSpeed: float (struct_fx32)
    pathwalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    state: int (POINTER(I))
    ```
    """
...
class struct_teresa_t(Structure):
    ...
    ```python
    mobj: struct_mobj_inst_t (struct_mobj_inst_t)
    fieldA0: Float[Tensor, "3"] (struct_VecFx32)
    alpha: int (POINTER(H))
    nsbtpFrame: int (POINTER(H))
    flip: int (POINTER(H))
    PADDING_0: list[int] (POINTER(B)[2])
...
class struct_traffic_params_t(Structure):
    ...
    ```python
    field0: float (struct_fx32)
    field4: float (struct_fx32)
    field8: float (struct_fx32)
    fieldC: float (struct_fx32)
    field10: float (struct_fx32)
    field14: float (struct_fx32)
    field18: float (struct_fx32)
    field1C: float (struct_fx32)
...
class struct_traffic_renderpart_t(Structure):
    ...
    ```python
    renderPart: struct_mobj_render_part_t (struct_mobj_render_part_t)
    playerIpatDir: Float[Tensor, "3"] (struct_VecFx32)
...
class struct_traffic_t(Structure):
    ...
    mobj: struct_mobj_inst_t (struct_mobj_inst_t)
    fieldA0: int (POINTER(i))
    fieldA4: Float[Tensor, "4"] (struct_quaternion_t)
    fieldB4: Float[Tensor, "4"] (struct_quaternion_t)
    fieldC4: Float[Tensor, "4"] (struct_quaternion_t)
    fieldD4: int (POINTER(i))
    pathWalker: struct_pw_pathwalker_t (struct_pw_pathwalker_t)
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    field110: float (struct_fx32)
    field114: float (struct_fx32)
    field118: float (struct_fx32)
    field11C: float (struct_fx32)
    field120: float (struct_fx32)
    model: POINTER_T[struct_model_t] (POINTER(struct_model_t))
    shadowModel: POINTER_T[struct_shadowmodel_t] (POINTER(struct_shadowmodel_t))
    nsbtpAnim: POINTER_T[struct_anim_manager_t] (POINTER(struct_anim_manager_t))
    nsbtpFrame: int (POINTER(H))
    light: struct_light_t (struct_light_t)
    field144: Float[Tensor, "3"] (struct_VecFx32)
    field150: int (POINTER(H))
    ...
    mobj: struct_mobj_inst_t
    fieldA0: int
    fieldA4: Float[Tensor, "4"]
    fieldB4: Float[Tensor, "4"]
    fieldC4: Float[Tensor, "4"]
    fieldD4: int
    pathWalker: struct_pw_pathwalker_t
    initialPoint: int
    fieldFE: int
...
class struct_trl_trail_t(Structure):
    ...
    shouldDie: int (POINTER(i))
    initialPointSize: float (struct_fx32)
    driverId: int (POINTER(I))
    driverOffset: Float[Tensor, "3"] (struct_VecFx32)
    ```
    """
    _pack_: ClassVar[int] = 1
    link: struct_NNSFndLink
    ...
    shouldDie: int
    initialPointSize: float
    driverId: int
    driverOffset: Float[Tensor, "3"]
...
class struct_trophy_t(Structure):
    ...
    identity: Float[Tensor, "4 3"] (union_MtxFx43)
    light0DirX: float (struct_fx16)
    light1DirX: float (struct_fx16)
    light0DirY: float (struct_fx16)
    light1DirY: float (struct_fx16)
    light0DirZ: float (struct_fx16)
    light1DirZ: float (struct_fx16)
    sparkleEmitterPos: Float[Tensor, "3"] (struct_VecFx32)
    sparkleEmitterRadius: float (struct_fx32)
    ...
    light0DirZ: float
    light1DirZ: float
    sparkleEmitterPos: Float[Tensor, "3"]
    sparkleEmitterRadius: float
...
class struct_water_state_t(Structure):
    """
    ```python
    waterAPosition: Float[Tensor, "3"] (struct_VecFx32)
    waterCPosition: Float[Tensor, "3"] (struct_VecFx32)
    basePosition: Float[Tensor, "3"] (struct_VecFx32)
    state: int (POINTER(I))
    tideAmplitude: float (struct_fx32)
    tidePhase: int (POINTER(H))
    tideSpeed: int (POINTER(H))
    tideProgress: float (struct_fx32)
    field34: int (POINTER(H))
    field36: int (POINTER(H))
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    waterAMoveDistance: float (struct_fx32)
    waterCMoveDistance: float (struct_fx32)
    field4C: float (struct_fx32)
    ...
    transformMtx: Float[Tensor, "4 3"] (union_MtxFx43)
    ...
    """
    _pack_: ClassVar[int] = 1
    waterAPosition: Float[Tensor, "3"]
    waterCPosition: Float[Tensor, "3"]
    basePosition: Float[Tensor, "3"]
    state: int
    tideAmplitude: float
    tidePhase: int
    ...
    waterMoveSpeed: int
    PADDING_0: list[int]
    waterAMoveDistance: float
    waterCMoveDistance: float
    field4C: float
...
class struct_wbox_t(Structure):
    ...
    PADDING_0: list[int] (POINTER(B)[2])
    fieldB0: Float[Tensor, "3"] (struct_VecFx32)
    floorNormal: Float[Tensor, "3"] (struct_VecFx32)
    rotY: int (POINTER(H))
    PADDING_1: list[int] (POINTER(B)[2])
    fieldCC: Float[Tensor, "3"] (struct_VecFx32)
    fieldD8: Float[Tensor, "3"] (struct_VecFx32)
    fieldE4: Float[Tensor, "3"] (struct_VecFx32)
    ...
    PADDING_0: list[int]
    fieldB0: Float[Tensor, "3"]
    floorNormal: Float[Tensor, "3"]
    rotY: int
    PADDING_1: list[int]
    fieldCC: Float[Tensor, "3"]
    fieldD8: Float[Tensor, "3"]
    fieldE4: Float[Tensor, "3"]
    fieldF0: int
    PADDING_2: list[int]
