...
htmlhelp_basename = 'py-desmumeDoc'
...
latex_documents = [
    (master_doc, 'py-desmume.tex', 'py-desmume Documentation',
     'Marco "Capypara" Köpcke', 'manual'),
]
...
man_pages = [
    (master_doc, 'py-desmume', 'py-desmume Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py-desmume', 'py-desmume Documentation',
     author, 'py-desmume', 'Python library to interface with DeSmuME, the Nintendo DS emulator',
     'Miscellaneous'),
]
